...
\end{verbatim}
   ...
   \item {\sffamily transcoord}
      ...
      This is necessary to implement the Spilhaus projection which rotates the
      point of reference to 49.56371678 South and 66.94970198 East. This can be
...
\begin{itemize}
   ...
   \item {\sffamily incomplete} (\textsc{experimental})
      ...
      the input data. This may be useful to download these objects to complete
